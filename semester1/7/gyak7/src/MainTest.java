...
class MainTest {
    ...
    @Test
    void haziHarom_minusz() {
        assertThrows(IllegalArgumentException.class, () -> Main.haziHarom(-1, 1));
    }

    @Test
    void haziHarom_0() {
        assertThrows(IllegalArgumentException.class, () -> Main.haziHarom(-1, 0));
    }
    ...
    void haziHarom_15_3() {
        final int a = 15;
        final int b = 3;
        assertEquals("5/1 + 1/5", Main.haziHarom(a, b));
    }
